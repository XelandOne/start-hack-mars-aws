...
Greenhouse objective: Supplement a significant fraction of total caloric intake (target variable for optimization).
...
Protein per astronaut: ~90–135 g/day
For 4 astronauts: ~360–540 g protein/day
...
Trade-off: Higher yield may require higher energy input.

AI agents must optimize: Yield per unit of energy and water.
...
Maximize: Nutritional Coverage Score
...
Where:
Nutritional Coverage Score = Weighted coverage of calories + protein + micronutrients.
